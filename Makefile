...
run-interactions:
	@forge script script/Interactions.s.sol:FundFundMe --rpc-url $(SEPOLIA_RPC_URL) --account defaultKey_MM --sender 0xb85daDEDA787Fa44CFFe18921ed771F6C1Cc754b --broadcast
